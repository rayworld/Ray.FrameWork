...
namespace Ray.Framework.DBUtility
{
    public abstract class OracleHelper
    {
        ...
        {
            return ExecuteNonQuery(OracleConnectionString, CommandType.Text, CmdText, commandParameters);
        }
        ...
        {
            return ExecuteDataSet(OracleConnectionString, CommandType.Text, cmdText, commandParameters);
        }
        ...
        {
            return ExecuteReader(OracleConnectionString, CommandType.Text, CmdText, commandParameters);
        }
        ...
        {
            return ExecuteScalar(OracleConnectionString, CommandType.Text, CmdText, commandParameters);
        }
        #endregion
