...
namespace Ray.Framework.PinYing
{
    public sealed class PinYingHelper
    {
        /// <summary>
        /// 包含字符 ASC 码的整形数组。
        /// </summary>
        ...
        public static string Convert(string chs, string separator, bool initialCap)
        {
            ...
            // 例外词组
            foreach (DictionaryEntry de in PinYingHelper.Phrase)
            {
        ...
        {
            return PinYingHelper.Convert(chs, separator, false);
        }
        ...
        {
            return PinYingHelper.Convert(chs, "", initialCap);
        }
        ...
        {
            return PinYingHelper.Convert(chs, "");
        }
    }
}